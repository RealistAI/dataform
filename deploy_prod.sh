...
mv replace/whitestone_master_schedule_staging_prod.sqlx definitions/staging/ && mv definitions/staging/whitestone_master_schedule_staging_test.sqlx replace/
